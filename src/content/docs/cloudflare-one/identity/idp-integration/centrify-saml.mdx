...
title: Centrify (SAML)
description: Learn how to integrate Centrify as a SAML provider with Cloudflare Zero Trust. Follow step-by-step instructions for secure access management.
---
