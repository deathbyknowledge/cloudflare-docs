...
You'll build a **real-time multiplayer chess game** that demonstrates these capabilities. Players can start or join games, make moves on an interactive chessboard, and even ask ChatGPT for strategic advice—all without leaving the conversation.
...
Once enabled, you'll be able to install custom apps during development and testing.

## Step 2 — Create your ChatGPT App project
...
## Step 4 — Create the Chess game engine
...
## Step 5 — Create the MCP server and UI resource
...
3. Click **"Start a new game"** to create a game
...
6. Click **"Ask for help"** to get strategic advice from ChatGPT


:::note
You might need to manually select the connector in the prompt box the first time you use it. Click **"+"** -> **"More"** -> **[App name]**.
:::
