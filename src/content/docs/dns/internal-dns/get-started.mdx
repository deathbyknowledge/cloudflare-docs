...
Since the resolver policy will require a view ID, you must have at least one view to be able to route requests to Internal DNS.
...
<Details header="DNS view requirements">
TBD > add partial with requirements from Setup page
</Details>
...
Refer to [connectivity](/dns/internal-dns/setup/connectivity/) for further context.